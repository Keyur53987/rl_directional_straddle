...
def main():
    ...
    try:
        ...
        if RETRAIN_MODEL_PATH and os.path.exists(RETRAIN_MODEL_PATH):
            ...
            model = PPO("MlpPolicy", env, seed=42, verbose=1, learning_rate=learning_rate, n_steps=n_steps, batch_size=batch_size, gamma=gamma,ent_coef=ent_coef, tensorboard_log=LOG_DIR, device='cuda')
