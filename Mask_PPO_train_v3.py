"""
MaskablePPO Training Script for Directional Straddle v3
========================================================
v3: Multi-horizon reward (1/30/120 step) with separate CE/PE PnL.
Obs space: 69 features. Uses Mask_PPO_config_v3.
"""
...
def main():
    ...
    print(f"=" * 60)
    print(f"  MaskablePPO Training — Directional Straddle v3")
    ...
    try:
        ...
        def make_env(rank, seed=0):
            def _init():
                env = IntradayOptionEnvV3(**env_kwargs)
        ...
        def make_eval_env():
            def _init():
                env = IntradayOptionEnvV3(**eval_env_kwargs)
                env = ActionMasker(env, mask_fn)
        ...
        metadata = {
            ...
            "reward_settings": {
                ...
                "PNL_W1": config.PNL_W1,
                "PNL_W30": config.PNL_W30,
                "PNL_W120": config.PNL_W120,
